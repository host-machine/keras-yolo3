...
#GT_PATH = os.path.join(os.getcwd(), 'input', 'ground-truth')        ###路径修改
#DR_PATH = os.path.join(os.getcwd(), 'input', 'detection-results')   ###路径修改
# if there are no images then no animation can be shown
#IMG_PATH = os.path.join(os.getcwd(), 'input', 'images-optional')    ###路径修改

GT_PATH = os.path.join(os.getcwd(), 'Object-Detection-Metrics-master', 'groundtruths')        ###路径修改
DR_PATH = os.path.join(os.getcwd(), 'Object-Detection-Metrics-master', 'detections')   ###路径修改
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'VOCdevkit', 'VOC2007', 'JPEGImages')    ###路径修改
